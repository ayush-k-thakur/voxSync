...
# # Configure API keys
# aai.settings.api_key = "047ef50b22254de285de847b1e285acb"
# genai.configure(api_key="AIzaSyBqFCcqMDj4bAmZMF8EGxnlUgRxsZi_yMY")
...
#         transcript_text = " ".join([utterance.text for utterance in transcript.utterances])
#     finally:
#         if os.path.exists(file_location):
#             os.remove(file_location)

#     # Prompt Gemini AI to summarize
